...
export var defaultImage =
  'https://bosscdn.otosaas.com/test/20220718/20220718162033%E4%B8%8B%E8%BD%BD.png?path=0,348';
export var MAX_UPLOAD_SIZE = 1024 * 1024;
export var PHOTO_TYPES = /(gif|jpe?g|png|GIF|JPG|PNG|bmp|svg)$/;
export var token =
...
export var BASE_PRICE_TYPE_ENUMS = [
  {
    label: '样式一',
    value: 1,
  },
...
export var REST_PRICE_TYPE_ENUMS = [
  {
    label: '样式三',
    value: 3,
  },
];
export var baseURL = '/api/v1';
export var FORMAT = 'YYYY-MM-DD HH:mm:ss';
export var iframeURL =
  process.env.NODE_ENV === 'development'
    ? 'http://'.concat(location.hostname, ':8002/')
    : location.host.includes('test')
    ? 'https://dev-view.otosaas.com/'
    : 'https://view.otosaas.com/';
export var TABLE_SCROLL = {
  y: 450,
};
