  ...
  function KpFileManage(props) {
    ...
    _this.handleClickFileItem = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(index) {
        var _this$props$selectedL, selectedList, formatSelectedList, _calcURLPath, breadcrumb, selected, dataSource, newActiveIndex;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                document.body.style.overflowY = 'hidden'; // 新增时：
