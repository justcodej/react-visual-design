(function (global, factory) {
    ...
    ***************************************************************************** */
        ...
        var renderComponent = function () {
            ...
            var onChange = !Formily.Core.isVoidField(field)
                ? function () {
                    ...
                    (_b = (_a = field.componentProps) === null || _a === void 0 ? void 0 : _a.onChange) === null || _b === void 0 ? void 0 : _b.call.apply(_b, __spreadArray([_a], __read(args)));
                }
            ...
            var onFocus = !Formily.Core.isVoidField(field)
                ? function () {
                    ...
                    (_b = (_a = field.componentProps) === null || _a === void 0 ? void 0 : _a.onFocus) === null || _b === void 0 ? void 0 : _b.call.apply(_b, __spreadArray([_a], __read(args)));
                }
            ...
            var onBlur = !Formily.Core.isVoidField(field)
                ? function () {
                    ...
                    (_b = (_a = field.componentProps) === null || _a === void 0 ? void 0 : _a.onBlur) === null || _b === void 0 ? void 0 : _b.call.apply(_b, __spreadArray([_a], __read(args)));
                }
    ...
    var Field = function (props) {
        var form = useForm();
        var parent = useField();
        var field = useAttach(form.createField(__assign({ basePath: parent === null || parent === void 0 ? void 0 : parent.address }, props)));
        return (React.createElement(FieldContext.Provider, { value: field },
            React.createElement(ReactiveField, { field: field }, props.children)));
    };
    ...
    var render = function (element) {
        ...
        if (Formily.Shared.globalThisPolyfill.document) {
            env$1.portalDOM =
                env$1.portalDOM || Formily.Shared.globalThisPolyfill['document'].createElement('div');
            env$1.ReactDOM =
                env$1.ReactDOM || Formily.Shared.globalThisPolyfill['ReactDOM'] || require('react-dom');
            //eslint-disable-next-line
            return env$1.ReactDOM.createPortal(element, env$1.portalDOM);
        }
        else {
