...
var SortableRow = (0, react_sortable_hoc_1.SortableElement)(function (props) { return react_1.default.createElement("tr", __assign({}, props)); });
var SortableBody = (0, react_sortable_hoc_1.SortableContainer)(function (props) { return react_1.default.createElement("tbody", __assign({}, props)); });
...
var useArrayTableColumns = function (dataSource, field, sources) {
    return sources.reduce(function (buf, _a, key) {
        ...
        return buf.concat(__assign(__assign({}, columnProps), { key: key, dataIndex: name, render: function (value, record) {
                ...
                var children = (react_1.default.createElement(array_base_1.ArrayBase.Item, { index: index, record: function () { var _a; return (_a = field === null || field === void 0 ? void 0 : field.value) === null || _a === void 0 ? void 0 : _a[index]; } },
...
var StatusSelect = (0, react_2.observer)(function (props) {
    ...
    var options = (_a = props.options) === null || _a === void 0 ? void 0 : _a.map(function (_a) {
        ...
        return {
            label: hasError ? react_1.default.createElement(antd_1.Badge, { dot: true }, label) : label,
            value: value,
        };
    });
    var width = String(options === null || options === void 0 ? void 0 : options.length).length * 15;
    return (react_1.default.createElement(antd_1.Select, { value: props.value, onChange: props.onChange, options: options, virtual: true, style: {
            width: width < 60 ? 60 : width,
        }, className: (0, classnames_1.default)("".concat(prefixCls, "-status-select"), {
    ...
    var renderPagination = function () {
        ...
        return (react_1.default.createElement("div", { className: "".concat(prefixCls, "-pagination") },
            react_1.default.createElement(antd_1.Space, null,
                react_1.default.createElement(StatusSelect, { value: current, pageSize: pageSize, onChange: handleChange, options: pages, notFoundContent: false }),
                react_1.default.createElement(antd_1.Pagination, __assign({}, props, { pageSize: pageSize, current: current, total: dataSource.length, size: size, showSizeChanger: false, onChange: handleChange })))));
    };
    return (react_1.default.createElement(react_1.Fragment, null,
        react_1.default.createElement(PaginationContext.Provider, { value: { totalPage: totalPage, pageSize: pageSize, changePage: handleChange } }, (_a = props.children) === null || _a === void 0 ? void 0 : _a.call(props, dataSource === null || dataSource === void 0 ? void 0 : dataSource.slice(startIndex, endIndex + 1), renderPagination()))));
};
var RowComp = function (props) {
    return react_1.default.createElement(SortableRow, __assign({ index: props['data-row-key'] || 0 }, props));
};
exports.ArrayTable = (0, react_2.observer)(function (props) {
    ...
    var WrapperComp = (0, react_1.useCallback)(function (props) { return (react_1.default.createElement(SortableBody, __assign({ useDragHandle: true, lockAxis: "y", helperClass: "".concat(prefixCls, "-sort-helper"), helperContainer: function () {
            var _a;
    ...
    return (react_1.default.createElement(ArrayTablePagination, __assign({}, pagination, { dataSource: dataSource }), function (dataSource, pager) { return (react_1.default.createElement("div", { ref: ref, className: prefixCls },
        react_1.default.createElement(array_base_1.ArrayBase, { onAdd: onAdd, onCopy: onCopy, onRemove: onRemove, onMoveUp: onMoveUp, onMoveDown: onMoveDown },
            react_1.default.createElement(antd_1.Table, __assign({ size: "small", bordered: true, rowKey: defaultRowKey }, props, { onChange: function () { }, pagination: false, columns: columns, dataSource: dataSource, components: {
                    body: {
                        wrapper: WrapperComp,
                        row: RowComp,
                    },
