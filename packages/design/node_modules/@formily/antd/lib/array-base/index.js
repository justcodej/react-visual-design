...
var SortHandle = (0, react_sortable_hoc_1.SortableHandle)(function (props) {
    ...
    return (react_1.default.createElement(icons_1.MenuOutlined, __assign({}, props, { className: (0, classnames_1.default)("".concat(prefixCls, "-sort-handle"), props.className), style: __assign({}, props.style) })));
});
...
exports.ArrayBase.Index = function (props) {
    var index = useIndex();
    var prefixCls = (0, __builtins__1.usePrefixCls)('formily-array-base');
    return (react_1.default.createElement("span", __assign({}, props, { className: "".concat(prefixCls, "-index") }),
        "#",
        index + 1,
        "."));
};
exports.ArrayBase.Addition = function (props) {
    ...
    if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable' &&
        ...
        return null;
    return (react_1.default.createElement(antd_1.Button, __assign({ type: "dashed", block: true }, props, { disabled: self === null || self === void 0 ? void 0 : self.disabled, className: (0, classnames_1.default)("".concat(prefixCls, "-addition"), props.className), onClick: function (e) {
        ...
        }, icon: (0, shared_1.isUndef)(props.icon) ? react_1.default.createElement(icons_1.PlusOutlined, null) : props.icon }), props.title || self.title));
};
exports.ArrayBase.Copy = react_1.default.forwardRef(function (props, ref) {
    ...
    if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable')
        return null;
    return (react_1.default.createElement(antd_1.Button, __assign({ type: "text" }, props, { disabled: self === null || self === void 0 ? void 0 : self.disabled, className: (0, classnames_1.default)("".concat(prefixCls, "-copy"), (self === null || self === void 0 ? void 0 : self.disabled) ? "".concat(prefixCls, "-copy-disabled") : '', props.className), ref: ref, onClick: function (e) {
            ...
            if ((_a = array.props) === null || _a === void 0 ? void 0 : _a.disabled)
                return;
            var value = (0, shared_1.clone)((_b = array === null || array === void 0 ? void 0 : array.field) === null || _b === void 0 ? void 0 : _b.value[index]);
        ...
        }, icon: (0, shared_1.isUndef)(props.icon) ? react_1.default.createElement(icons_1.CopyOutlined, null) : props.icon }), props.title || self.title));
});
exports.ArrayBase.Remove = react_1.default.forwardRef(function (props, ref) {
    ...
    if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable')
        return null;
    return (react_1.default.createElement(antd_1.Button, __assign({ type: "text" }, props, { disabled: self === null || self === void 0 ? void 0 : self.disabled, className: (0, classnames_1.default)("".concat(prefixCls, "-remove"), (self === null || self === void 0 ? void 0 : self.disabled) ? "".concat(prefixCls, "-remove-disabled") : '', props.className), ref: ref, onClick: function (e) {
            var _a, _b, _c, _d;
            if (self === null || self === void 0 ? void 0 : self.disabled)
                return;
            e.stopPropagation();
        ...
        }, icon: (0, shared_1.isUndef)(props.icon) ? react_1.default.createElement(icons_1.DeleteOutlined, null) : props.icon }), props.title || self.title));
});
exports.ArrayBase.MoveDown = react_1.default.forwardRef(function (props, ref) {
    ...
    if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable')
        return null;
    return (react_1.default.createElement(antd_1.Button, __assign({ type: "text" }, props, { disabled: self === null || self === void 0 ? void 0 : self.disabled, className: (0, classnames_1.default)("".concat(prefixCls, "-move-down"), (self === null || self === void 0 ? void 0 : self.disabled) ? "".concat(prefixCls, "-move-down-disabled") : '', props.className), ref: ref, onClick: function (e) {
            var _a, _b, _c, _d;
            if (self === null || self === void 0 ? void 0 : self.disabled)
                return;
            e.stopPropagation();
        ...
        }, icon: (0, shared_1.isUndef)(props.icon) ? react_1.default.createElement(icons_1.DownOutlined, null) : props.icon }), props.title || self.title));
});
exports.ArrayBase.MoveUp = react_1.default.forwardRef(function (props, ref) {
    ...
    if (((_a = array.field) === null || _a === void 0 ? void 0 : _a.pattern) !== 'editable')
        return null;
    return (react_1.default.createElement(antd_1.Button, __assign({ type: "text" }, props, { disabled: self === null || self === void 0 ? void 0 : self.disabled, className: (0, classnames_1.default)("".concat(prefixCls, "-move-up"), (self === null || self === void 0 ? void 0 : self.disabled) ? "".concat(prefixCls, "-move-up-disabled") : '', props.className), ref: ref, onClick: function (e) {
            var _a, _b, _c;
            if (self === null || self === void 0 ? void 0 : self.disabled)
                return;
            e.stopPropagation();
        ...
        }, icon: (0, shared_1.isUndef)(props.icon) ? react_1.default.createElement(icons_1.UpOutlined, null) : props.icon }), props.title || self.title));
});
