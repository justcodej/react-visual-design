...
exports.Checkbox = (0, react_1.connect)(antd_1.Checkbox, (0, react_1.mapProps)({
    value: 'checked',
}));
exports.Checkbox.__ANT_CHECKBOX = true;
exports.Checkbox.Group = (0, react_1.connect)(antd_1.Checkbox.Group, (0, react_1.mapProps)({
    dataSource: 'options',
