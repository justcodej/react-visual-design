...
var StatusSelect = observer(function (props) {
    ...
    return (React.createElement(Select, { value: props.value, onChange: props.onChange, options: options, virtual: true, style: {
    ...
    var renderPagination = function () {
        ...
        return (React.createElement("div", { className: "".concat(prefixCls, "-pagination") },
            React.createElement(Space, null,
                ...
                React.createElement(Pagination, __assign({}, props, { pageSize: pageSize, current: current, total: dataSource.length, size: size, showSizeChanger: false, onChange: handleChange })))));
    };
...
export var ArrayTable = observer(function (props) {
    ...
    var WrapperComp = useCallback(function (props) { return (React.createElement(SortableBody, __assign({ useDragHandle: true, lockAxis: "y", helperClass: "".concat(prefixCls, "-sort-helper"), helperContainer: function () {
            var _a;
